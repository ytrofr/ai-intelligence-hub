/**
 * Hermes Radar Route - GET /api/hermes-radar
 * Joins the curated Hermes adoption audit (config/hermes-radar.json) with live
...
const CONFIG_PATH = path.join(__dirname, "..", "config", "hermes-radar.json");
...
router.get("/", (req, res) => {
  ...
  try {
    ...
    console.error("Hermes Radar error:", error.message);
